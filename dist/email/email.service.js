...
let EmailService = class EmailService {
    ...
    async sendContactReply(recipientEmail, recipientName, originalMessage, replyMessage) {
        try {
    ...
    async sendAppointmentConfirmation(recipientEmail, recipientName, appointmentDate, appointmentTime, serviceName) {
        try {
            await this.mailerService.sendMail({
                to: recipientEmail,
    ...
    async sendAppointmentStatusUpdate(recipientEmail, recipientName, appointmentDate, appointmentTime, serviceName, status) {
        const statusColors = {
